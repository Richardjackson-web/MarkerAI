    ...
    <>
      <div className="">
        ...
        <div className="hidden md:block transform -translate-y-12">
          <div className="md:flex lg:mx-20 md:mx-10 flex-row my-28">
            <div className="basis-1/2">
              <h1 className="text-grad-0 font-lexend font-normal my-5 text-6xl leading-tight">
                Grade Assessments Faster with AI.
              </h1>
              <p className="text-grad-0 font-lexend font-normal my-7 text-base leading-8">
                Transform your grading process with our AI-powered assessment
                tool. Save time, maintain consistency, and focus more on
                teaching.
              </p>
              <Link to="/signup">
        ...
        <div className="block mb-20 md:hidden">
          ...
          <div className="mx-7">
            <h1 className="text-grad-0 font-lexend font-normal my-5 text-3xl">
              Grade Assessments Faster with AI.
            </h1>
            <p className="text-grad-0 font-lexend font-normal my-5 text-sm">
              Transform your grading process with our AI-powered assessment
              tool. Save time, maintain consistency, and focus more on teaching.
            </p>
        ...
        <div className="text-center">
          <div>
            <button className="font-lexend text-feat-0 inline-flex items-center bg-amber-500 py-2 px-8 mx-2 border-2 text-1xl rounded-3xl">
              Features
            </button>
            <h3 className="text-grad-0 font-lexend md:text-3xl text-2xl py-3">
              What makes Marker-AI useful?
            </h3>
          </div>
          <div className="md:flex flex-row mt-7">
            <div className="basis-1/3 mb-6">
              ...
              <p className="text-grad-0 font-medium my-3 text-lg">
                Smart Recognition
              </p>
              <p className="text-grad-0 text-sm">
                Advanced AI technology accurately
                <br /> recognizes and processes handwritten
                <br /> assessments
              </p>
            ...
            <div className="basis-1/3 mb-6 mt-14 sm:mt-0">
              ...
              <p className="text-grad-0 text-sm">
                Upload and customize your marking
                <br /> criteria for consistent grading across all
                <br /> assessments.
              </p>
              <FaArrowRightLong className="block mx-auto mt-7 text-grad-0" />
            </div>
            <div className="basis-1/3 mt-14 sm:mt-0">
              ...
              <p className="text-grad-0 text-sm">
                Get detailed insights into student
                <br /> performance and grading patterns.
              </p>
              <FaArrowRightLong className="block mx-auto mt-7 text-grad-0" />
            </div>
          </div>
          <button className="text-white-0 font-lexend text-sm inline-flex items-center bg-blue1000-0 py-2 px-8 rounded-2xl my-11">
        ...
        <div className="hidden md:block mt-20">
          <div className="text-center">
            ...
            <h3 className="text-grad-0 font-lexend sm:text-3xl text-2xl py-3">
              Why choose Marker-AI?
            </h3>
          </div>
          <div className="md:flex flex-row mt-7 pl-32">
            <div className="basis-1/3">
              ...
              <p className="text-grad-0 font-medium my-3 text-lg">
                Ease, efficiency and time-saving
              </p>
              <p className="text-grad-0 text-sm">
                Marker-AI takes the some workload
                <br /> off you and frees you up to focus in.
              </p>
            </div>
            <div className="basis-1/3 mt-10 md:mt-0">
              ...
              <p className="text-grad-0 text-sm">
                Ensures fair and accurate grading
                <br /> by removing human bias and error.
              </p>
            </div>
            <div className="basis-1/3 mt-10 md:mt-0">
              ...
              <p className="text-grad-0 text-sm">
                Receive insights and feedback on
                <br /> each test you can share with your student.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="md:mt-20 mt-7">
          <div className="text-center md:mb-20 mb-10">
            <button className="font-lexend text-feat-0 inline-flex items-center bg-amber-500 py-2 px-8 mx-2 border-2 border-t-white-0 text-1xl rounded-3xl">
              Pricing
            </button>
            <h3 className="text-grad-0 font-lexend md:text-3xl text-2xl py-3">
          ...
          <div className="md:flex flex-row mt-7">
            ...
            <div className="basis-1/5 grid place-items-center">
              <div className="bg-gray-0 py-0.5 w-80 md:w-full text-center">
                <p className="text-grad-0 font-medium my-3 text-2xl font-lexend">
                  Basic
                </p>
                <p className="text-grad-0 text-sm font-lexend mb-8">
                  <span className="font-bold">₦5,000</span> /month
                </p>
              </div>
              <div className="leading-8 mt-2">
                <span className="inline-flex">
                  <FaCheck className="block mx-auto pr-1 mt-2 text-lg text-arr-0" />{" "}
                  Consequat ex proident.
                </span>
                <br />
                <span className="inline-flex">
                  <FaCheck className="block mx-auto mt-2 pr-1 text-lg text-arr-0" />{" "}
            ...
            <div className="basis-1/5 transform md:-translate-y-10">
              <div className="grid place-items-center">
                ...
                <div className="bg-gray-0 py-0.5 text-center w-80 md:w-full">
                  ...
                  <p className="text-grad-0 text-sm font-lexend mb-8">
                    <span className="font-bold">₦15,000</span> /month
                  </p>
                </div>
            ...
            <div className="basis-1/5 grid place-items-center">
              <div className="bg-gray-0 py-0.5 text-center w-80 md:w-full">
                ...
                <p className="text-grad-0 text-sm font-lexend mb-8">
                  <span className="font-bold">₦30,000</span> /month
                </p>
              </div>
              <div className="leading-8 mt-2">
                <span className="inline-flex">
          ...
          <div>
            ...
            <div className="md:grid grid-cols-2 bg-gray-0 lg:mx-8 p-8 rounded-xl">
              <div className="basis-1/2">
                <img
                  src={Info}
                  alt=""
                  className="md:rounded-l-lg rounded-xl w-full h-full"
                />
              </div>
              <div className="basis-1/2 py-8 mx-5 pt-16">
                <form>
                  <div class="space-y-12">
                    <div class="border-gray-900/10">
                      <h2 class="text-base/7 font-lexend md:text-center font-medium text-gray-900">
                        Send us a message
                      </h2>
                      ...
                      <div class="mt-5 grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                          <div class="mt-2">
                            <input
                              ...
                              className="block w-full rounded-md font-lexend bg-gray-0 px-3 py-1.5 text-base text-tert-0 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                            />
                          </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                          <div class="mt-2">
                            <input
                              ...
                              id="email-address"
                              autocomplete="email"
                              className="block w-full rounded-md bg-gray-0 font-lexend px-3 py-1.5 text-base text-tert-0 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                            />
                          </div>
                        </div>
                        ...
                        <div class="mt-2 col-span-full">
                          <textarea
                            ...
                            id="about"
                            rows="4"
                            className="block w-full rounded-md bg-gray-0 px-3 py-1.5 text-base text-tert-0 font-lexend outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                          ></textarea>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="mt-6 md:text-center gap-x-6">
                    <button
                      type="submit"
                      className="font-lexend rounded-md bg-blue1000-0 text-white-0 px-14 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Send message
                    </button>
                  </div>
          ...
          <div className="bg-blue1000-0 mt-32 py-7 md:px-20 px-7">
            <div className="md:flex flex-row">
              <div className="basis-1/2 md:mb-0 mb-5">
                ...
                <p className="font-istock flex md:text-[6px] text-[8px] text-white-0">
                  <GoDash className="mt-0.5" /> AI FOR EDUCATORS
                  <GoDash className="mt-0.5" />
                </p>
                <p className="font-istock flex md:text-[10px] text-[12px] mt-5 text-white-0">
                  <AiOutlineCopyright className="mt-0.5" /> 2025. Marker-AI. All
                  Rights Reserved.
                </p>
              </div>
              <div className="md:flex flex-row basis-1/2 ml-auto text-white-0 font-lexend font-extralight md:text-xs text-lg">
                ...
                <div className="basis-1/3 md:mt-0 mt-5">
                  ...
                  <br className="hidden md:block" />
                  <span className="inline-flex">
                    <CiMail className="mt-1 mr-3" /> admin@markerai.org
                  </span>
                  <br />
                  <span className="inline-flex">
                    <FaWhatsapp className="mt-1 mr-3" /> +234 706 856 6789
                  </span>
                </div>
                <div className="basis-1/3 md:mt-0 mt-5">
                  ...
                  <div className="flex text-lg">
                    ...
                    <LiaInstagram className="mr-3" />{" "}
                    <MdOutlineFacebook className="mr-3" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:flex flex-row">
              <div className="basis-1/2 mt-5 mb-5 md:mb-0">
                <p className="text-white-0 font-lexend text-lg font-extralight">
