    ...
    <>
      <div className="grid md:grid-cols-3 grid-cols-2 gap-5 px-10">
        <div className="rounded-lg shadow-2xl shadow-grey-0 col-span-2 md:col-span-1 w-80 md:w-[25vw] mx-auto">
          <div className="bg-lightBlue-0 py-1.5 rounded-t-xl"></div>
        ...
        <div className="rounded-lg shadow-2xl shadow-grey-0 md:w-[25vw]">
          <div className="bg-purple300-0 py-1.5 rounded-t-xl"></div>
          <div className="py-9 text-center font-lexend text-purple400-0">
        ...
        <div className="rounded-lg shadow-2xl shadow-grey-0 md:w-[25vw]">
          <div className="bg-orange-0 py-1.5 rounded-t-xl"></div>
          <div className="py-9 text-center font-lexend text-purple400-0">
      ...
      <div className="mt-9 px-10">
        ...
        <div className="mt-3 grid grid-cols-2 md:block">
          <select
            className="ml-auto border rounded-lg border-blue1000-0 font-lexend text-blue700-0 px-7 py-4 mr-3"
            name=""
            id=""
          >
