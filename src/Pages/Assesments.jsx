        ...
        <>
                <div className="grid grid-cols-3 gap-4 px-10">
                    <div className="rounded-lg shadow-2xl shadow-grey-0">
                        <div className="bg-pink-0 py-1.5 px-40 rounded-t-xl w-full md:w-full">
                    ...
                    <div className="rounded-lg shadow-2xl shadow-grey-0">
                        <div className="bg-purple100-0 py-1.5 px-40 rounded-t-xl w-full md:w-full">
                    ...
                    <div className="rounded-lg shadow-2xl shadow-grey-0">
                        <div className="bg-blue1000-0 py-1.5 px-40 rounded-t-xl w-full md:w-full">
