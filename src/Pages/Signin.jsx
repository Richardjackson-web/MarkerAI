            ...
            <div className="md:flex flex-row">
                            <div className="basis-1/2">
                                ...
                                <div className="my-6 text-center">
                                    <h3 className="font-lexend text-2xl">Sign In To Your Account</h3>
                                </div>
                                <div className="flex justify-center items-center">
                                    <form className="text-center" onSubmit={handleSubmit}>
                                        ...
                                        <div class="mt-2 relative">
                                            ...
                                            <p className="text-left text-[13px] mb-5 font-lexend text-purple400-0 -mt-6"><a href="">Forgot Password?</a></p>
                                        </div>
                                        <button type="submit" className="text-white-0 text-center font-lexend bg-blue1000-0 px-16 mt-2.5 py-2 rounded-lg md:w-96">Sign In</button>
                                    </form>
                                    {message && <p>{message}</p>}
                                </div>
                                <div className="my-3 text-center">
                                    <small className="font-DMSans">Don't have an account? <Link to="/signup"><a href="" className="text-blue1000-0">Sign Up</a></Link></small>
                                    <p className="mt-3 font-DMSans">Or</p>
                                </div>
                                <div className="md:flex mb-16 text-center justify-center items-center">
                                    <div>
                                        <button className="inline-flex text-sm md:mr-4 text-blue1000-0 border-blue500-0 border-2 rounded-xl px-12 py-2 font-DMSans"><img src={Google} width={15} alt="" className="mt-1 mr-2" /> Sign In with Google</button>
                                    </div>
                                    <div className="mt-3 md:mt-0">
                                        <button className="inline-flex text-sm md:ml-4 text-blue1000-0 border-blue500-0 border-2 rounded-xl px-14 py-2 font-DMSans"><img src={Apple} width={19} alt="" className="mt-0.5" />Sign In with Apple</button>
                                    </div>
                                </div>
                            </div>
