                ...
                <div className="basis-1/2">
                    ...
                    <div className="flex justify-center items-center">
                        <form className="" onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="text-white-0 text-center font-lexend bg-blue1000-0 px-32 mt-2.5 py-2 rounded-lg w-96">Sign Up</button>
                        </form>
                        {message && <p>{message}</p>}
                    </div>
                    ...
                    <div className="flex justify-center items-center">
                        <button className="inline-flex text-sm mr-4 text-blue1000-0 border-blue500-0 border-2 rounded-xl px-8 py-2 font-DMSans"><img src={Google} width={15} alt="" className="mt-1 mr-2" /> Sign Up with Google</button>
                        <button className="inline-flex text-sm ml-4 text-blue1000-0 border-blue500-0 border-2 rounded-xl px-8 py-2 font-DMSans"><img src={Apple} width={19} alt="" className="mt-0.5" />Sign Up with Apple</button>
                    </div>
                </div>
