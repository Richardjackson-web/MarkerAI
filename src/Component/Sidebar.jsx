  ...
  return (
    <>
      <div className="relative">
        <div className="fixed pt-14 px-8 border rounded-lg border-blue300-0 md:h-screen bg-white-0">
            ...
            <div className="relative">
              <div className="fixed bottom-0">
                ...
                <div className="pb-7">
                  <Link to="/settings">
                    <a className="flex" href="">
                      <BsFillQuestionCircleFill className="mt-1 mr-2" /> Help & Support
                    </a>
                  </Link>
                </div>
              </div>
